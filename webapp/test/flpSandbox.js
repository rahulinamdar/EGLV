		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "EGLV",
									"targetURL": "#comdemoprototype-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemoprototype-display": {
								"semanticObject": "comdemoprototype",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.prototype",
									"url": sap.ui.require.toUrl("com/demo/prototype")
								}
							}
						}
					}
